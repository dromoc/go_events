...
func NewAMQPEventEmitter(conn *amqp.Connection, exchange string) (message_queue.EventEmitter, error) {
...
func (a *amqpEventEmitter) Emit(event message_queue.Event) error {
	channel, err := a.connection.Channel()
	if err != nil {
		return err
	}
