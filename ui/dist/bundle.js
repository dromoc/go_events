...
Object.defineProperty(exports, "__esModule", { value: true });
const event_list_item_1 = __webpack_require__(/*! ./event_list_item */ "./src/components/event_list_item.tsx");
const React = __webpack_require__(/*! react */ "react");
class EventList extends React.Component {
    render() {
        const items = this.props.events.map(e => React.createElement(event_list_item_1.EventListItem, { event: e }));
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "react");
const event_list_1 = __webpack_require__(/*! ./event_list */ "./src/components/event_list.tsx");
        ...
        return React.createElement("nav", { className: "navbar navbar-default" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "navbar-header" },
                    React.createElement(react_router_dom_1.Link, { to: "/", className: "navbar-brand" }, this.props.brandName)),
                React.createElement("ul", { className: "nav navbar-nav" },
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: "/" }, "Events")))));
    }
}
...
const react_router_dom_1 = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
const event_list_container_1 = __webpack_require__(/*! ./components/event_list_container */ "./src/components/event_list_container.tsx");
const navigation_1 = __webpack_require__(/*! ./components/navigation */ "./src/components/navigation.tsx");
class App extends React.Component {
    render() {
        const eventList = () => React.createElement(event_list_container_1.EventListContainer, { eventServiceURL: "http://localhost:8181" });
        return React.createElement(react_router_dom_1.HashRouter, null,
            React.createElement("div", null,
                React.createElement(navigation_1.Navigation, { brandName: "MyEvents" }),
                React.createElement("div", { className: "container" },
                    React.createElement("h1", null, "My Events"),
                    React.createElement(react_router_dom_1.Route, { exact: true, path: "/", component: eventList }))));
    }
}
